...
depends=('atk>=1.26.0' 'pango>=1.24.2' 'libxcursor' 'libxinerama' 'libxrandr>=1.3.0' 'libxi>=1.2.1' 'libcups>=1.3.10-3' 'libxcomposite' 'libxdamage' 'heimdal>=1.2.1' 'gnutls>=2.8.0' 'shared-mime-info')
