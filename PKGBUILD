...
depends=('mesa' 'glu' 'cairo' 'gtk3' 'libsoup' 'gstreamer' 'openvdb' 'wayland' 'wayland-protocols' 'libxkbcommon' 'gst-libav' 'webkit2gtk-4.1')
...
source=("bambustudio-${pkgver}.AppImage::https://github.com/bambulab/BambuStudio/releases/download/v${pkgver}/Bambu_Studio_linux_fedora-v${pkgver/65/64}.AppImage"
	"BambuStudio.desktop"
	"bambu-studio")
sha256sums=('f64cc931c0f49ee0acb1f8b9577e49f47d7c0a892120625deafdf0afdf5b2bd3'
            'SKIP'
            'SKIP')
