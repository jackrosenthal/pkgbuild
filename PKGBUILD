...
arch=('x86_64')
depends=('libvips' 'openjpeg2' 'electron39' 'nodejs' 'vulkan-driver')
makedepends=('unzip')
provides=($_pkgname)
conflicts=($_pkgname)
options=('!strip')
...
sha512sums=(
  ...
  'df86c8a66330079820865175c472965dae488e35c64472361d5a400bcec0353ad2c2039161177fc9784fb567c13017bf2a143782770f72e1cead617f9080a6df'
